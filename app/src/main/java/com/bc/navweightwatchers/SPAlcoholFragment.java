...
public class SPAlcoholFragment extends ListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        SimpleAdapter pointsListAdapter = new SimpleAdapter(getActivity(), myList, R.layout.spalcoholmenu, new String[] {"Item", "Weight", "Points"}, new int[] {R.id.flitem, R.id.flgrams, R.id.flpointsLayout});
        try {
	...
	public void createHashMap(Activity c) throws IOException{
    	...
    	InputStream is = c.getAssets().open("alcohol.bc");
